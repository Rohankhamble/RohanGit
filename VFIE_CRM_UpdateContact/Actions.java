...
//	String ticket = null;
	...
	return 0;
	     ...
	     //SubscriberServices_l9UpdateParam(ctx, lr.eval_string("<p_subsriberId>"), lr.eval_string("<param_name>"),lr.eval_string("<param_value>"));
	...
	private CreateContact createContact()
	{
		...
		personDetails.setPhoneNumberX2("<p_phone>");
		personDetails.setPhone("<p_phonenumber>");
		...
		personIdentificationDetails.setDocumentNumber("Z<p_DocumentNo>");
